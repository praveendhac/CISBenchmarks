...
if __name__ == "__main__":
    ...
    print "Hardening Checks for any Linux not covered by Centre for Internet Security Benchmarks"
    print "This template applies to any Linux other than Debian, Ubuntu, Amazon, CentOS, Oracle, Red Hat and SUSE"
